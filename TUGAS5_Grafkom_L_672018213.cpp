...
void myKeyboard(unsigned char key, int x, int y){
 ...
 else if (key == 'e') skalaY+=0.5;//menonjolkan
 else if (key == 'r') skalaY-=0.5;//kebalikkan e
 else if (key == 'x')//putar vertikal pada porosnya
    {
  x1=1;
  y1=0;
  z1=0;
 ...
 else if (key == 'y')//putar horizontal pada porosnya
    {
  y1=1;
  x1=0;
  z1=0;
 ...
 else if (key == 'z')//putar vertikal ke horizontal
 {
  y1=0;
  x1=0;
  z1=1;
...
int main(int argc, char** argv){
 ...
 glutCreateWindow("YONAS JUNIANTIKO PUTRO - 672018213");
